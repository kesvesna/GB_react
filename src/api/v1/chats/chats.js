...
export const addNewMessageToChatApi = (message, chatId, author) => firebaseDb.ref(`chats/${chatId}/messages`).push({message: message, author: author,  date: format(new Date(), 'dd:MM:yyyy HH:mm:ss')});
